-- Add Indonesian language columns to FAQ block tables
-- Add question_id and answer_id columns for Indonesian translations

-- Add columns to version table
ALTER TABLE public._pages_v_blocks_faq_block_faq_items 
ADD COLUMN IF NOT EXISTS question_id character varying NULL,
ADD COLUMN IF NOT EXISTS answer_id jsonb NULL;
