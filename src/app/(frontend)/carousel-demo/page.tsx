  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-300">
      ...
      <div className="container mx-auto px-8 py-12">
        ...
        <div className="relative w-full h-96 md:h-[32rem] lg:h-[40rem] rounded-lg overflow-hidden bg-gray-200 dark:bg-gray-700 flex items-center justify-center">
        ...
        <div className="mt-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
              <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">🔄 Auto-Play</h3>
              <p className="text-gray-600 dark:text-gray-400">
