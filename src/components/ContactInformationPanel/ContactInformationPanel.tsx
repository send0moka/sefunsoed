...
const ContactCard: React.FC<ContactCardProps> = ({
  ...
  return (
    <div
      className={`bg-white dark:bg-neutral-900 rounded-lg border border-neutral-200 dark:border-neutral-700 p-6 shadow-sm dark:shadow-neutral-900/20 transition-all duration-300 ${hoverClasses} ${cardClassName}`}
    >
