      ...
      <div className="flex gap-2">
        {shareButtons.map((button) => (
          <button
            ...
            className={cn(
              'flex items-center gap-2 px-3 py-2 rounded-lg border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 transition-all duration-200 hover:scale-105',
              button.color,
            )}
