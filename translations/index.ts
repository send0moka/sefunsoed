...
type DynamicContentKey = 'tentang-kami' | 'program-nudc' | 'program-toefl' | 'program-translation' | 'kontak'
...
export const translations: Translations = {
  en: {
    ...
    home: {
      hero: {
        ...
        description: 'A platform for developing English language skills and student leadership at UNSOED.',
      ...
      features: {
        ...
        description: 'SEF UNSOED provides various programs to help students develop their English language skills and leadership abilities.',
        nudc: {
          title: 'NUDC/KDMI Program',
          description: 'Program preparation for national and international English debate competitions.',
        },
        toefl: {
          title: 'TOEFL/UEPT Preparation',
          description: 'Program preparation for TOEFL and UEPT tests with structured materials and test simulations.',
        },
        translation: {
          title: 'Translation & Proofreading',
          description: 'Translation and proofreading services for academic and non-academic documents.',
        },
      },
      cta: {
        title: 'Join SEF UNSOED',
        description: 'Be part of a community focused on developing English language skills and leadership.',
        registerButton: 'Register Now',
        learnMore: 'Learn More',
      },
    },
    content: {
      hero: {
        ...
        description: 'Discover various educational content to improve your English skills.'
      },
      articles: {
        title: 'Articles',
        ...
        items: [
          {
            ...
            description: 'Practical guide to improve your English speaking skills.',
            author: 'John Doe',
            date: 'March 15, 2024',
            readTime: '5 min read',
            category: 'Education'
          },
          {
            ...
            description: 'Learn proper techniques for writing essays in English.',
            author: 'Jane Smith',
            date: 'March 10, 2024',
            readTime: '7 min read',
            category: 'Education'
          },
          {
            ...
            description: 'Complete guide to using Present Perfect Tense in English.',
            author: 'Mike Johnson',
            date: 'March 5, 2024',
            readTime: '6 min read',
            category: 'Education'
      ...
      newsletter: {
        ...
        description: 'Get the latest updates about SEF UNSOED programs and activities.',
        readMore: 'Read More',
        items: [
          {
            id: 1,
            title: 'SEF Newsletter #1',
            description: 'Latest updates about SEF UNSOED programs and activities.',
            date: 'March 1, 2024'
          },
          {
            id: 2,
      ...
      specialDays: {
        ...
        description: 'Articles related to important days in language and education.',
        readMore: 'Read More',
        items: [
          {
            id: 1,
            title: 'International Mother Language Day',
            description: 'Understanding the importance of mother tongue and language diversity in the world.',
            date: 'February 21, 2024'
          },
          {
            id: 2,
            title: 'World Poetry Day',
            description: 'Celebrating the beauty of poetry in various languages.',
            date: 'March 21, 2024'
          },
          {
            id: 3,
      ...
      podcast: {
        ...
        description: 'Listen to our podcast for English learning tips and tricks.',
        duration: 'Duration',
        listen: 'Listen Now',
        items: [
          {
            ...
            description: 'Discussion about effective methods of learning English.',
            duration: '15:30',
            date: 'March 1, 2024'
          },
          {
            ...
            description: 'How to improve your public speaking skills in English.',
            duration: '20:15',
            date: 'February 15, 2024'
          },
          {
    ...
    registration: {
      ...
      requirements: {
        ...
        description: 'Here are the general requirements that must be met to register for SEF UNSOED programs.',
        items: [
      ...
      options: {
        nudc: {
          name: 'NUDC/KDMI',
          description: 'Registration for national and international debate competition preparation program.',
          status: 'Open'
        },
        webinar: {
          name: 'Webinar',
          description: 'Registration for various English language and self-development webinars.',
          status: 'Open'
        },
        toefl: {
          name: 'TOEFL/UEPT',
        ...
        committee: {
          name: 'Committee',
          description: 'Registration to become a committee member in various SEF UNSOED events.',
          status: 'Open'
        },
        member: {
          name: 'SEF Member',
    ...
    registrationForm: {
      ...
      description: 'Please fill out the form below to register for our programs.',
      name: 'Full Name',
    ...
    about: {
      hero: {
        ...
        description: 'Developing English language skills and student leadership at UNSOED.'
      },
      programKerja: {
        title: 'Work Programs',
      ...
      faq: {
        ...
        description: 'Find answers to frequently asked questions about SEF UNSOED.',
        items: [
          {
            question: 'What is SEF UNSOED?',
            answer: 'SEF UNSOED is a student forum focused on developing English language skills and student leadership at UNSOED.'
          },
          {
            question: 'How to join SEF UNSOED?',
            answer: 'You can join by participating in the registration process held every semester. Registration information can be found on the Registration page.'
          },
          {
            question: 'What programs are available at SEF UNSOED?',
            answer: 'SEF UNSOED provides various programs such as NUDC/KDMI preparation, TOEFL/UEPT, and translation & proofreading services.'
          },
          {
            question: 'Is there a fee to join?',
            answer: 'Yes, there is a membership fee used to support SEF UNSOED activities and programs. Detailed information can be seen during registration.'
          }
        ]
      },
      contact: {
    ...
    programs: {
      hero: {
        ...
        description: 'Discover various programs and activities available at SEF UNSOED.'
      },
      events: {
        title: 'Events',
        ...
        items: [
          {
            title: 'NUDC Training',
            description: 'Training preparation for National University Debating Championship.',
            date: 'March 15, 2024',
        ...
        items: [
          {
            ...
            description: 'SEF UNSOED debate team won first place in regional competition.',
            date: 'February 10, 2024'
          },
          {
            title: 'TOEFL Success Rate 95%',
            description: '95% of TOEFL program participants achieved their target score.',
            date: 'February 5, 2024'
          },
          {
            title: 'Best English Club Award',
            description: 'SEF UNSOED received award as the best English Club in Central Java.',
            date: 'February 1, 2024'
          }
        ]
      },
      sponsors: {
        ...
        description: 'Strategic partners supporting SEF UNSOED programs and activities.',
        items: [
          {
    ...
    services: {
      hero: {
        title: 'Our Services',
        description: 'SEF UNSOED provides quality translation and proofreading services to meet your needs.'
      },
      services: {
        title: 'Services',
        ...
        items: [
          {
            ...
            description: 'Document translation service from Indonesian to English and vice versa.',
            features: [
              'Academic documents',
              'Business documents',
              'Legal documents',
          ...
          },
          {
            ...
            description: 'Grammar, spelling, and format checking and correction service for English documents.',
            features: [
        ...
        steps: [
          {
            ...
            description: 'Submit the document you want to translate or check through the registration form.'
          },
          {
            name: 'Review & Quotation',
            description: 'Our team will review the document and provide a price quote.'
          },
          {
            name: 'Confirmation & Payment',
            description: 'After confirmation, make payment according to the given quote.'
          },
          {
            name: 'Process',
            description: 'Our team will process the document according to the selected service.'
          },
          {
          ...
          },
          {
            ...
            description: 'The completed document will be delivered according to the agreed time.'
          }
        ]
      }
    }
  ...
  id: {
    ...
    home: {
      hero: {
        title: 'Student English Forum UNSOED',
        description: 'Wadah pengembangan kemampuan bahasa Inggris dan kepemimpinan mahasiswa UNSOED.',
      ...
      features: {
        ...
        description: 'SEF UNSOED menyediakan berbagai program untuk membantu mahasiswa mengembangkan kemampuan bahasa Inggris dan kepemimpinan mereka.',
        nudc: {
      ...
      cta: {
        ...
        description: 'Jadilah bagian dari komunitas yang berfokus pada pengembangan kemampuan bahasa Inggris dan kepemimpinan.',
        registerButton: 'Daftar Sekarang',
        learnMore: 'Pelajari Lebih Lanjut',
      },
    },
    content: {
      hero: {
        ...
        description: 'Temukan berbagai konten edukasi untuk meningkatkan kemampuan bahasa Inggris Anda.'
      },
      articles: {
        title: 'Artikel',
        subtitle: 'Artikel Edukasi',
        description: 'Artikel-artikel yang dapat membantu Anda dalam belajar bahasa Inggris.',
      ...
      newsletter: {
        ...
        description: 'Dapatkan update terbaru tentang program dan kegiatan SEF UNSOED.',
        readMore: 'Baca Selengkapnya',
        items: [
          {
            id: 1,
      ...
      specialDays: {
        ...
        description: 'Artikel-artikel yang berkaitan dengan hari-hari penting dalam dunia bahasa dan pendidikan.',
        readMore: 'Baca Selengkapnya',
        items: [
          {
            id: 1,
      ...
      podcast: {
        ...
        description: 'Dengarkan podcast kami untuk tips dan trik belajar bahasa Inggris.',
        duration: 'Durasi',
    ...
    footer: {
      ...
      address: {
        line1: 'Jl. Prof. Dr. HR Boenyamin No.708, Grendeng, Kec. Purwokerto Utara',
    ...
    registration: {
      title: 'Pendaftaran',
      description: 'Pilih program yang sesuai dengan kebutuhan Anda dan daftar sekarang.',
      registerButton: 'Daftar Sekarang',
      learnMore: 'Pelajari Lebih Lanjut',
      requirements: {
        title: 'Persyaratan',
        subtitle: 'Persyaratan Umum',
        description: 'Berikut adalah persyaratan umum yang harus dipenuhi untuk mendaftar di program SEF UNSOED.',
        items: [
    ...
    registrationForm: {
      ...
      description: 'Silakan isi formulir di bawah ini untuk mendaftar program kami.',
      name: 'Nama Lengkap',
      studentId: 'NIM',
      faculty: 'Fakultas',
      major: 'Jurusan',
    ...
    about: {
      hero: {
        ...
        description: 'Mengembangkan kemampuan bahasa Inggris dan kepemimpinan mahasiswa UNSOED.'
      },
      programKerja: {
        title: 'Program Kerja',
        subtitle: 'Program & Kegiatan',
        description: 'Berbagai program dan kegiatan yang tersedia di SEF UNSOED.',
        sections: {
          pembelajaran: {
      ...
      faq: {
        ...
        description: 'Temukan jawaban untuk pertanyaan yang sering diajukan tentang SEF UNSOED.',
        items: [
          {
      ...
      contact: {
        ...
        description: 'Jangan ragu untuk menghubungi kami jika Anda memiliki pertanyaan.',
        address: {
          title: 'Alamat',
          content: [
    ...
    programs: {
      hero: {
        ...
        description: 'Temukan berbagai program dan kegiatan yang tersedia di SEF UNSOED.'
      },
      events: {
        title: 'Events',
        subtitle: 'Kegiatan Mendatang',
        description: 'Berbagai kegiatan yang akan segera dilaksanakan oleh SEF UNSOED.',
      ...
      sponsors: {
        ...
        description: 'Partner strategis yang mendukung program dan kegiatan SEF UNSOED.',
        items: [
          {
            name: 'British Council',
    ...
    services: {
      hero: {
        title: 'Layanan Kami',
        description: 'SEF UNSOED menyediakan layanan penerjemahan dan proofreading berkualitas untuk memenuhi kebutuhan Anda.'
      },
      services: {
        title: 'Layanan',
